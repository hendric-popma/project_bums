...
#     else:
#         if color == "s":
#             img_b_or_w = 255 - image
#         else:
#             raise ValueError("Ungültige Farbauswahl. Gültige Optionen sind s oder w.")
...
#     persantage = 0.13
#     thresh_percent = 1-persantage
    
#     index_1 = int(num_values * thresh_percent)  # Index für den 13% Punkt
#     threshold_2 = int(max_gray - (max_gray*persantage))
...
#     img_dilate = cv2.dilate(seg.astype('uint8'), np.ones((3,3)), iterations=7)
#     #plt.imshow(img_dilate)
